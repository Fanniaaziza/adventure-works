...
df_sales = pd.read_sql(query_sales_yearly, conn)
...
df_bubble = pd.read_sql(query_bubble, engine)
...
df_sales_by_region = pd.read_sql(query_pie, engine)
...
# Baca ke DataFrame
df = pd.read_sql(query_bar, engine)
